...
facebook <- readxl::read_excel("../Dta/07-21.xlsx",
                               sheet = "Facebook",
...
forums <- readxl::read_excel("../Dta/07-21.xlsx",
                               sheet = "Forums",
                               col_types = column_data_types) %>% 
  row_to_names(.,1) %>% 
  clean_names() %>%
...
twitter <- readxl::read_excel("../Dta/07-21.xlsx",
                               sheet = "Twitter",
                               col_types = column_data_types) %>% 
  row_to_names(.,1) %>% 
  clean_names() %>%
...
press <- readxl::read_excel("../Dta/07-21.xlsx",
                               sheet = "Press",
                               col_types = column_data_types) %>% 
  row_to_names(.,1) %>% 
  clean_names() %>%
...
insta <- readxl::read_excel("../Dta/07-21.xlsx",
                               sheet = "Instagram",
                               col_types = column_data_types) %>% 
  row_to_names(.,1) %>% 
  clean_names() %>%
