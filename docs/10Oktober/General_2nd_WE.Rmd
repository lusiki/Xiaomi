...
author: "Weakly Croatian media overview"
...
path <- "../Dta/08_11_2021-15_11_2021.xlsx"
...
xiaomi <- readxl::read_excel("../dta/Weekly/08_11_2021-15_11_2021.xlsx") %>% 
  row_to_names(.,1) %>% 
  clean_names() %>%
...
<br>
<br>
.footnote[[*] On demand avaliable reports for Facebook, Forums, Portals, Twitter, Youtube, Press and Instagram.]
