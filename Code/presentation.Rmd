...
xiaomiD <- read.csv2("../Dta/Xiaomi full.csv") %>%
  select(X.3) %>%
  row_to_names(.,1) %>%
...
xiaomi <- readxl::read_excel("../Dta/Xiaomi full.xlsx") %>% 
  row_to_names(.,1) %>% 
  clean_names() %>%
...
.footnote[[*]Number of distinct publications that mention the word in the whole text corpora.]
...
.footnote[[*]Percentage (%) of word in the text corpora on a given day.]
...
```{r landscapeFreqBrand, echo=FALSE, message=FALSE, warning=FALSE, fig.height = 4, fig.width=10}
...
# Most important articles by impressions
<br>
<br>
...
# Most important articles by engagement
<br>
<br>
...
# Most important articles by likes
<br>
<br>
...
# Most important authors (by impressions)
<br>
<br>
...
# Most important authors (by engagements)
<br>
<br>
...
# Most important authors (by likes)
<br>
<br>
...
# Most important authors (by audience)
<br>
<br>
...
forums <- readxl::read_excel("../Dta/Xiaomi full.xlsx",
                               sheet = "Forums",
                               col_types = column_data_types) %>% 
  row_to_names(.,1) %>% 
  clean_names() %>%
...
# Most important forums by activity
<br>
<br>
...
# Most important forums by impressions
<br>
<br>
...
# Most important forums by engagements
<br>
<br>
...
portals <- readxl::read_excel("../Dta/Xiaomi full.xlsx",
                               sheet = "Portals",
                               col_types = column_data_types) %>% 
  row_to_names(.,1) %>% 
  clean_names() %>%
...
twitter <- readxl::read_excel("../Dta/Xiaomi full.xlsx",
                               sheet = "Twitter",
                               col_types = column_data_types) %>% 
  row_to_names(.,1) %>% 
  clean_names() %>%
...
# Most important tweets (by impressions)
<br>
<br>
...
yt <- readxl::read_excel("../Dta/Xiaomi full.xlsx",
                               sheet = "YouTube",
                               col_types = column_data_types) %>% 
  row_to_names(.,1) %>% 
  clean_names() %>%
...
press <- readxl::read_excel("../Dta/Xiaomi full.xlsx",
                               sheet = "Press",
                               col_types = column_data_types) %>% 
  row_to_names(.,1) %>% 
  clean_names() %>%
...
press %>%
  ...
  select(source, Impressions, Articles) %>%
  kable() %>%
    kable_styling() %>%
     scroll_box(width = "600px", height = "400px")
...
insta <- readxl::read_excel("../Dta/Xiaomi full.xlsx",
                               sheet = "Instagram",
                               col_types = column_data_types) %>% 
  row_to_names(.,1) %>% 
  clean_names() %>%
...
# Most important posts (by impressions)
<br>
<br>
